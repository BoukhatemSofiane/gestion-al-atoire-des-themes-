 ...
 * 
 */
@WebServiceClient(name = "LoginWebService", targetNamespace = "http://projetServiceWeb.com/", wsdlLocation = "http://localhost:8080/bkhWebService/LoginWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINWEBSERVICE_QNAME = new QName("http://projetServiceWeb.com/", "LoginWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/bkhWebService/LoginWebService?wsdl");
    ...
    public LoginWebService getLoginWebServicePort() {
        return super.getPort(new QName("http://projetServiceWeb.com/", "LoginWebServicePort"), LoginWebService.class);
    }
    ...
    public LoginWebService getLoginWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://projetServiceWeb.com/", "LoginWebServicePort"), LoginWebService.class, features);
    }
